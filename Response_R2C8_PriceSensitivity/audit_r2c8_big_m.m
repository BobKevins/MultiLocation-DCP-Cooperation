function audit_table = audit_r2c8_big_m(cfg, stage1_result, scenario_name)
%AUDIT_R2C8_BIG_M 核验当前 R2C8 场景的 Stage 2 成本 Big-M。
...
%% ================================== 01 逐 DCP 精确边界 ==================================
required_big_m = zeros(cfg.number_dc, 1);                                     % 各 DCP 所需成本 Big-M，USD
...
audit_table = table( ...
    ...
    (1:cfg.number_dc)', required_big_m, configured_big_m, margin, is_sufficient, ...
    'VariableNames', { ...
